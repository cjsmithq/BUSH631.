...
dim(leaders)
# There are 250 leaders represented in the leaders.csv file.
length(unique(leaders$result))
# At least ten countries experience at least ten assassination attempt.
mean(table(leaders$year))
# The average assassination attempts per year in these countries is 2.45.
```
